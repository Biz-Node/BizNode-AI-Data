...
> **이 문서는 검색 계층의 정본입니다.** 예전에는 **설계서**와 **현황서** 두 파일이었고,
> 2026-09-05 에 하나로 합쳤습니다. 본문에서 「설계서」라고 하면 **설계편**, 「현황서」라고
> 하면 **현황편**을 가리킵니다.
>
> | 편 | 무엇을 다루나 | 언제 고치나 |
> |---|---|---|
> | **[설계편](#설계편--어떻게-만들기로-했고-왜-그렇게-했는가)** | 어떻게 만들기로 했고, **왜** 그렇게 했는가 | 설계 결정이 바뀔 때 |
> | **[현황편](#현황편--지금-어디까지-됐고-무엇이-고장났고-다음에-무엇을-하는가)** | 지금 어디까지 됐고, 무엇이 고장났고, 다음에 무엇을 하는가 | ★**작업이 끝날 때마다** |
>
> ★**절 번호는 두 편이 각각 0번부터 시작합니다.** 합치면서 번호를 다시 매기지
> 않았습니다 — 본문과 다른 문서가 「§3」·「§12」로 262곳에서 참조하고 있어, 번호를
> 밀면 그 참조가 **조용히** 어긋납니다. 헷갈릴 자리에서는 「설계 §3」·「현황 §12」로
> 편을 함께 적습니다.
>
...
> 코드 위치는 [코드 지도](CODEMAP.md), Agent 루프 구조는
> [Agent 아키텍처](BizNode_Agent_Architecture_Design.md) 입니다.

**1부** 마지막 갱신 **2026-09-05** · 기준 커밋 `6c39289`(브랜치 `yun`)
**2부** 마지막 갱신 **2026-09-05** · 브랜치 `yun`
