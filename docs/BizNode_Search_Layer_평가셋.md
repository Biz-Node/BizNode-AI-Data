...
>
> ```bash
> .venv-wsl/bin/python -m tests.search.eval.report -o BizNode_Search_Layer_평가셋.md
> ```
...
| 현재 실제 결과         | mode=NAME · anchor='삼성전자' · direction=없음 · edge_types=없음 · 1건 · postgres · Company 1 · 상위 삼성전자 · 60ms |
...
| 현재 실제 결과         | mode=NAME · anchor='농심' · direction=없음 · edge_types=없음 · 1건 · postgres · Company 1 · 상위 농심 · 41ms |
...
| 현재 실제 결과         | mode=NAME · anchor='SK하이닉스' · direction=없음 · edge_types=없음 · 1건 · postgres · Company 1 · 상위 SK하이닉스 · 41ms     |
...
| 현재 실제 결과         | mode=NAME · anchor='NAVER' · direction=없음 · edge_types=없음 · 1건 · postgres · Company 1 · 상위 NAVER · 41ms                         |
...
| 현재 실제 결과         | mode=RELATIONSHIP · anchor='삼성전자' · direction=outgoing · edge_types=['SUPPLIES_TO'] · 10건 · neo4j · Company 10 · 신선도 current 6 stale 4 · 상위 구글 · AMD · CSOT · 108ms |
...
| 현재 실제 결과         | mode=RELATIONSHIP · anchor='삼성전자' · direction=incoming · edge_types=['SUPPLIES_TO'] · 10건 · neo4j · Company 10 · 신선도 current 10 · 상위 SFA반도체 · ㈜원익아이피에스 · 링크솔루션 · 93ms |
...
| 현재 실제 결과         | mode=RELATIONSHIP · anchor='삼성전자' · direction=outgoing · edge_types=['OWNS_STAKE_IN'] · 10건 · neo4j · Company 10 · 신선도 current 10 · 상위 스킬드AI · 미스트랄AI · 주타코어 · 107ms |
...
| 현재 실제 결과         | mode=RELATIONSHIP · anchor='삼성전자' · direction=incoming · edge_types=['OWNS_STAKE_IN'] · 10건 · neo4j · Company 7 Person 3 · 신선도 current 6 stale 4 · 상위 삼성생명보험㈜ (특별계정) · 삼성화재해상보험 · 삼성복지재단 · 80ms |
...
| 현재 실제 결과         | mode=RELATIONSHIP · anchor='삼성전자' · direction=없음 · edge_types=['OWNS_STAKE_IN'] · 10건 · neo4j · Company 10 · 신선도 current 10 · 상위 스킬드AI · 삼성생명보험㈜ (특별계정) · 삼성화재해상보험 · 87ms |
...
| 현재 실제 결과         | mode=RELATIONSHIP · anchor='SK하이닉스' · direction=incoming · edge_types=['SUES'] · 8건 · neo4j · Company 4 Organization 3 Person 1 · 신선도 stale 6 current 2 · 상위 소비자 집단 · 김진원 · 넷리스트 · 53ms |
...
| 현재 실제 결과         | mode=RELATIONSHIP · anchor='삼성전자' · direction=없음 · edge_types=['PARTNERS_WITH'] · 10건 · neo4j · Company 9 Organization 1 · 신선도 current 10 · 상위 화웨이 · 레인보우로보틱스 · 에릭슨 · 74ms |
...
| 현재 실제 결과         | mode=RELATIONSHIP · anchor='삼성전자' · direction=없음 · edge_types=['IS_EXECUTIVE_OF'] · 10건 · neo4j · Person 10 · 신선도 current 6 stale 4 · 상위 신제윤 · 김준성 · 허은녕 · 51ms |
...
| 현재 실제 결과         | mode=RELATIONSHIP · anchor='삼성전자' · direction=없음 · edge_types=['REGULATES'] · 10건 · neo4j · Organization 10 · 신선도 current 10 · 상위 미국 정부 · 금융위원회 증권선물위원회 · 서울남부지검 금융·증권범죄합동수사부 · 52ms |
...
| 현재 실제 결과         | mode=RELATIONSHIP · anchor=None · direction=없음 · edge_types=['SUES'] · 8건 · neo4j · Company 8 · 신선도 current 8 · 상위 한미반도체 · 한화세미텍 · 넷리스트 · 126ms            |
...
| 현재 실제 결과         | mode=RELATIONSHIP · anchor='SK하이닉스' · direction=없음 · edge_types=['SUPPLIES_TO', 'DEPENDS_ON'] · 10건 · neo4j · Company 10 · 신선도 current 10 · 상위 넥스틴 · SFA반도체 · 엔비디아 · 70ms |
...
| 현재 실제 결과         | mode=RELATIONSHIP · anchor='삼성전자' · direction=incoming · edge_types=['SUPPLIES_TO'] · 10건 · neo4j · Company 10 · 신선도 current 9 stale 1 · 상위 SK하이닉스 · SFA반도체 · ㈜원익아이피에스 · 89ms                       |
...
| 현재 실제 결과         | mode=SEMANTIC · anchor=None · direction=없음 · edge_types=없음 · 10건 · chroma · Company 10 · 상위 한미반도체 · HD현대 · SK하이닉스 · 1734ms |
...
| 현재 실제 결과         | mode=SEMANTIC · anchor='네이버' · direction=없음 · edge_types=없음 · 10건 · chroma · Company 10 · 상위 NAVER · 현대오토에버 · 삼성전자 · 169ms                                                                                         |
...
| 현재 실제 결과         | mode=RELATIONSHIP · anchor='대상' · direction=없음 · edge_types=['HAS_EVENT'] · 0건 · 55ms                                                                                      |
...
- **기대** NAME · anchor='네이버'
- **실제** mode=SEMANTIC · anchor='네이버' · direction=없음 · edge_types=없음 · 10건 · chroma · Company 10 · 상위 NAVER · 현대오토에버 · 삼성전자 · 169ms
...
- **실제** mode=RELATIONSHIP · anchor='대상' · direction=없음 · edge_types=['HAS_EVENT'] · 0건 · 55ms
