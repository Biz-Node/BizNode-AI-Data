...
| 7 | `query-news-citable` | 파두 실적 논란 어떻게 됐어? | query | 호출 | 2 | PASS |
...
★캐시가 **17건 빗나갔습니다** — 그만큼 이 실행에서 직접 계산했고, 그 값은 실행마다 흔들립니다(현황서 §8-13). 기준선으로 쓰려면 `EMBED_CACHE_STRICT=1` 로 다시 재세요.
...
관계 kept **110** · cut **898** · 링 없는 근거 인용 **38**건(사건·뉴스 근거에는 링이 없습니다).
...
- **최종 인용 45건 중 38건이 관계가 아닙니다**(사건·뉴스 근거). 링 랭킹을 손대도 인용의 대부분은 안 움직인다는 뜻입니다.
...
| 링 | 본 것 없음 / 인용 없음 |
| 임베딩 | 3회 (적중 35 · 빗나감 5) |
| 예산 | 루프가 잘림 아니오 · 최종 플래그 예 (호출 2/12 · 사건 10/40 · 파급 36/12) |
| 소요 | 15652ms |
...
| 링 | 본 것 R0:3 · R1:415 · R2:115 · R3:37 / 인용 R1:2 |
| 임베딩 | 3회 (적중 144 · 빗나감 3) |
...
| 임베딩 | 3회 (적중 68 · 빗나감 3) |
| 예산 | 루프가 잘림 아니오 · 최종 플래그 예 (호출 4/12 · 사건 10/40 · 파급 303/12) |
| 소요 | 15732ms |
...
| 링 | 본 것 없음 / 인용 없음 |
| 임베딩 | 3회 (적중 24 · 빗나감 1) |
| 예산 | 루프가 잘림 아니오 · 최종 플래그 예 (호출 3/12 · 사건 10/40 · 파급 48/12) |
| 소요 | 14626ms |
