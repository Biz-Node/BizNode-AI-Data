...
| 11 | `query-event-info-leak` | 현대오토에버 정보유출 사건 | query | 호출 | 2 | PASS |
...
| 도구 호출 총계 | 34 |
| 케이스당 도구 호출 | 최소 1 · 중앙 2 · 최대 3 (상한 12) |
| ★**Agent 루프가 예산으로 잘린** 케이스 | 0 / 20 |
| 최종 `budget_exhausted` 플래그 | 9 / 20 |
| 임베딩 호출 | 33회 · 캐시 적중 1163 · 빗나감 15 |
...
관계 kept **110** · cut **898** · 링 없는 근거 인용 **33**건(사건·뉴스 근거에는 링이 없습니다).
...
- **최종 인용 39건 중 33건이 관계가 아닙니다**(사건·뉴스 근거). 링 랭킹을 손대도 인용의 대부분은 안 움직인다는 뜻입니다.
...
| 링 | 본 것 없음 / 인용 없음 |
| 임베딩 | 3회 (적중 24 · 빗나감 1) |
| 예산 | 루프가 잘림 아니오 · 최종 플래그 예 (호출 2/12 · 사건 10/40 · 파급 48/12) |
| 소요 | 16116ms |
