...
관계 kept **110** · cut **898** · 링 없는 근거 인용 **29**건(사건·검색히트·뉴스 근거에는 링이 없습니다 — **정상**) · 관계인데 링을 못 찾은 인용 **0**건(**0 이어야 정상**) · 근거 id 로 **되찾은** 인용 **0**건.
...
- **최종 인용 36건 중 29건이 관계가 아닙니다**(사건·뉴스 근거). 링 랭킹을 손대도 인용의 대부분은 안 움직인다는 뜻입니다.
...
| 실제 anchor | query · ['SK하이닉스'] |
| 실제 도구 | `get_events`×1 · `get_filings`×1 · `get_market`×1 · `get_relations`×1 (호출 4) |
...
| 링 | 본 것 없음 / 인용 없음 |
| 임베딩 | 3회 (적중 25 · 빗나감 0) |
| 예산 | 루프가 잘림 아니오 · 최종 플래그 아니오 (호출 2/12 · 사건 10/40 · 파급 7/12) |
| 소요 | 10102ms |
